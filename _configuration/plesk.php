<?php 
	...
	*/
	...
	##########################################################################################################################################	
	define("_CRON_FILES_FOLDER_FETCH_RMSTARTCOUNT_",  			0);								# Offset Filename off Zonefiles at Start (example cut first 5 letters of zone.domain.file) (default for ispconfig is 4)
	...
	define("_CRON_FILES_FOLDER_FETCH_",  						"/var/named/run-root/var"); 	# Folder to Search Files (default for ispconfig is "/etc/bind/zones/") // Set to false to deactivate
