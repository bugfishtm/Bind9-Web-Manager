...
<?php if($x = currentFormFunction($mysql, @$_GET["repondo"])) { 	
 ...
 if($x = currentFormFunction($mysql, @$_GET["dodeldomd"])) { 	
	...
	if($currentFormloc == "apidomains") {
		echo "<b>Slave Domains</b><br /><a href='#showmethepicture' class='sysbutton'>Explanations</a><br />Here you can see all domains, which have been replicated out of remote servers to this local server. The information you see here updates every time the cronjob sync.php has been executed. You can get some help about the status icons and more <a href='#showmethepicture'>here</a>...  ";
		echo 'The current data you see has been last updated: <font color="lime">'.@$ar["creation"].'</font>';
	}
	if($currentFormloc == "binddomains") {
		echo "<b>Master Domains</b><br /><a href='#showmethepicture' class='sysbutton'>Explanations</a><br/>Here you can see Master Domains on this local system. You can get some help about the status icons and more <a href='#showmethepicture'>here</a>... ";
		echo 'The current data you see has been last updated: <font color="lime">'.@$ar["creation"].'</font>';
	}
		echo "<br clear='left'>";
