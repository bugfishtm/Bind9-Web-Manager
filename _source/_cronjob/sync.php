<?php 
	...
	*************************************************************************/
	...
	/*************************************************************************
		Start Message
	*************************************************************************/		
	$log->info("Cronbjob sync.php has been started.", "cron_sync");
	
	/*************************************************************************
		Run the Cronjob to Execute all operations
	*************************************************************************/			
	dnshttp_cron_sync($mysql, $log);
		
	/*************************************************************************
		End Message
	*************************************************************************/		
	$log->info("Cronbjob sync.php has been finished.", "cron_sync");