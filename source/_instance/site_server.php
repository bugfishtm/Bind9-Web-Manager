...
endofex25632: ?>
	<?php echo '<div  class="content_box" style="max-width: 800px;text-align: center;"><a href="./?site=server&edit=add" class="sysbutton">Add new Server</a></div>';?>
	<?php
